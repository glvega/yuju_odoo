...
class ProductTemplate(models.Model):
    ...
    def mdk_create(self, product_data, id_shop=None):
        ...
        if not has_variations:
            ...
            try:
                ...
                new_product_data = new_product_simple.get_data_with_variations()
                response = {
                    "id": new_product_data.get("id"),
                    "default_code": new_product_data.get("default_code"),
                    "variations": []
                }
                if new_product_data.get("variations"):
                    for new_var in new_product_data["variations"]:
                        response["variations"].append({
                            "id": new_var.get("id"),
                            "default_code": new_var.get("default_code")
                        })
                return results.success_result(data=response)
        ...
        new_product_data = new_template.product_variant_id.get_data_with_variations()  
        response = {
            "id": new_product_data.get("id"),
            "default_code": new_product_data.get("default_code"),
            "variations": []
        ...
        return results.success_result(response)
    ...
    def change_product_status(self, template_id, active, id_shop=None):
        ...
        try:            
            ...
            new_product_data = product.product_variant_id.get_data_with_variations()
            response = {
                "id": new_product_data.get("id"),
                "default_code": new_product_data.get("default_code"),
                "variations": []
